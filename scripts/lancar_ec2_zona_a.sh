...
aws ec2 run-instances --image-id ami-02f3f602d23f1659d --count 1 --instance-type t3.micro --security-group-ids $security_group_id --subnet-id $subnet_id --user-data file://user_data_ec2_zona_a.sh
